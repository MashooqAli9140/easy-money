    ...
    <div>
      ...
      >
        ...
        <div id="nav-mid">
          ...
          <a href={id ? `/dashboard/sip-calculator/${id}` : "/signup"}>
            {" "}
            SIP Calculator{" "}
          </a>
        </div>
        ...
        <div id="nav-right-menu" style={{ display: id ? "block" : "none" }}>
          <i
            ...
            style={{ display: openmenu ? "none" : "block", color: "white" }}
          >
            {" "}
          </i>
          <i
            class="fa-solid fa-x fa-2x"
            onClick={() => setopenmenu(!openmenu)}
            style={{ display: openmenu ? "block" : "none", color: "white" }}
          ></i>
        </div>
      </div>
