...
const Stocks_page = () => {
  ...
  if (loading)
    return (
      <div style={{ textAlign: "center", margin: "50px" }}>
        {" "}
        <h1>Loading data for top 50 companies...</h1>{" "}
      </div>
    );
  ...
  async function MakeNewStockInvesting(e) {
    ...
    if (!c_name || !high || !stockAmount || !low || !close_val)
      ...
      <div>
        ...
        <div id="stocks-fund-hero">
          <div id="stocks-fund-02">
            <div>
              <h1 style={{ color: "#212426" }}>
                {" "}
                Top<span style={{ color: "#00B852" }}> 30 Stocks </span> to
                Invest{" "}
              </h1>
            </div>
      ...
      >
        <div id="invest-card-inner">
          ...
          <div id="stock-form">
            ...
            <div style={{ padding: "10px 0px 10px 0px", width: "100%" }}>
              <button
                onClick={(e) => MakeNewStockInvesting(e)}
                style={{ width: "100%" }}
                id="stock-invest"
              >
                {" "}
