...
{/* //BUTTONS PARTS */}
           ...
           <div>  
               <div style={{ padding:"10px 10px 10px 10px"}}>
                <button onClick={ () => navigate(-1)} style={{  cursor:"pointer", width:'100%', background:"red",color:"white", padding:"10px 15px 10px 15px",outline:"none",border:"none",borderRadius:"5px", fontSize:"16px"}}> Go back </button>
               </div>
            </div>
